sap.ui.define([
	...
	return Controller.extend("project.frotasapp.controller.BaseController", {
		...
		callService: function (sUrl, sMethod, fnSuccess, oBody) {
			fetch(sUrl, {
				method: sMethod,
				headers: {
				...
				.then(function (oResonse) {
					oResonse.json().then(function (r) {
						fnSuccess(r);
					});
				})
